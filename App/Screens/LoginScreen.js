...
const LoginScreen = ({ navigation }) => {
    ...
    const handleLogin = async () => {
        try {
            // Firebase Auth ile kullanıcı oturum açma
            await signInWithEmailAndPassword(auth, email, password);
            // Başarılı oturum açma sonrası ana uygulama ekranına yönlendirin
    ...
    const handleNavigateToRegister = () => {
        navigation.navigate('Register'); // `RegisterScreen`'e yönlendirin
    };
